...
class RepcoSpider(Spider):
    ...
    allowed_domains = ['www.repco.com.au', 'www.repco.co.nz']
    start_urls = ['https://www.repco.com.au/en/store-finder/store-locator?q=&page=0', 'https://www.repco.co.nz/en/store-finder/store-locator?q=&page=0']
    requires_proxy = 'AU'
