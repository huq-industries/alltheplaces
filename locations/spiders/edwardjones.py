...
class EdwardJonesSpider(SitemapSpider, StructuredDataSpider):
    ...
    def get_location(self, item, page):
        url = 'https://www.edwardjones.com/api/v3/financial-advisor/results?q={postcode}&distance=75&distance_unit=mi&page={page}&searchtype=2'.format(postcode=item['postcode'], page=page)
