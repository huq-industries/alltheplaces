...
class IntermarcheSpider(scrapy.Spider):
    ...
    INTERMARCHE_CONTACT = {'brand': 'Intermarché Contact', 'brand_wikidata': 'Q98278049'}
    INTERMARCHE_EXPRESS = {'brand': 'Intermarché Express', 'brand_wikidata': 'Q98278043'}
    ...
    def start_requests(self):
        yield Request(url='https://www.intermarche.com/api/service/pdvs/v4/pdvs/zone?r=10000&lat=43.646715&lon=1.433066&min=10000', headers={'x-red-version': '3', 'x-red-device': 'red_fo_desktop'})
    ...
    def parse(self, response, **kwargs):
        for place in response.json()['resultats']:
            ...
            if place.get('modelLabel') in ['SUPER ALIMENTAIRE', 'SUPER GENERALISTE']:
            ...
            elif place.get('modelLabel') == 'Réservé\xa0Soignants':
                continue
            elif place.get('modelLabel') == 'Retrait\xa0La\xa0Poste':
                continue
