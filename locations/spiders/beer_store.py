...
class BeerStoreSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for data in features:
            ...
            end_str = '<a href'
            properties = {'ref': data['properties']['storeid'], 'lon': data['geometry']['coordinates'][0], 'lat': data['geometry']['coordinates'][1], 'name': data['properties']['name'], 'street_address': description[:description.find(end_str)]}
