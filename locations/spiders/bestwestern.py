...
class BestWesternSpider(scrapy.spiders.SitemapSpider):
    name = 'bestwestern'
    brands = [('Best Western Premier', 'Q830334'), ('Best Western Plus', 'Q830334'), ('Aiden by Best Western', 'Q830334'), ('Sure Hotel', 'Q830334'), ('Surestay Plus', 'Q830334'), ('Surestay', 'Q830334'), ('Best Western', 'Q830334')]
    allowed_domains = ['bestwestern.com']
    sitemap_urls = ['https://www.bestwestern.com/etc/seo/bestwestern/hotels.xml']
    sitemap_rules = [('en_US/book/.*\\.html', 'parse_hotel')]
    download_delay = 2.0
        ...
        for brand in self.brands:
            if summary['name'].lower().startswith(brand[0].lower()):
                ...
                try:
                    ...
                    item['image'] = 'https://images.bestwestern.com/bwi/brochures/{}/photos/1024/{}'.format(summary['resort'], image_path)
                except IndexError:
                    pass
