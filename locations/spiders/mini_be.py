...
class MiniBESpider(scrapy.Spider):
    ...
    start_urls = ['https://www.mini.be/c2b-localsearch/services/api/v4/clients/BMWSTAGE2_DLO/BE/pois?brand=MINI&cached=off&category=MI&country=BE&language=nl&lat=0&lng=0&maxResults=700&showAll=true&unit=km']
