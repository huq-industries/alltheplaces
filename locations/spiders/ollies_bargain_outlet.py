...
class OlliesBargainOutletSpider(scrapy.Spider):
    ...
    def start_requests(self):
        formdata = {'Page': '0', 'PageSize': '1', 'StartIndex': '0', 'EndIndex': '5', 'Longitude': '-74.006065', 'Latitude': '40.712792', 'City': '', 'State': '', 'F': 'GetNearestLocations', 'RangeInMiles': '5000'}
    ...
    def get_all_locations(self, response):
        ...
        formdata = {'Page': '0', 'PageSize': str(number_locations), 'StartIndex': '0', 'EndIndex': '5', 'Longitude': '-74.006065', 'Latitude': '40.712792', 'City': '', 'State': '', 'F': 'GetNearestLocations', 'RangeInMiles': '5000'}
        url = 'https://www.ollies.us/admin/locations/ajax.aspx'
        headers = {'content-type': 'application/x-www-form-urlencoded; charset=UTF-8'}
