...
class DominosPizzaJPSpider(scrapy.Spider):
    ...
    item_attributes = {'brand': "Domino's", 'brand_wikidata': 'Q839466', 'country': 'JP'}
    allowed_domains = ['dominos.jp']
    start_urls = ['https://www.dominos.jp/sitemap.aspx']
    download_delay = 0.3
