...
class VolvoSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.volvocars.com/fr/dealers/concessionnaire', 'https://www.volvocars.com/fr-be/dealers/distributeurs', 'https://www.volvocars.com/de/dealers/haendlersuche', 'https://www.volvocars.com/es/dealers/concesionarios-talleres', 'https://www.volvocars.com/it/dealers/concessionari']
    user_agent = BROWSER_DEFAULT

    def parse(self, response):
        country = re.search('(\\w\\w)/dealers', response.url).group(1)
