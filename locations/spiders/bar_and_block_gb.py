...
class BarAndBlockGB(CrawlSpider):
    ...
    rules = [Rule(LinkExtractor(allow='\\/en-gb\\/locations\\/[-\\w]+$'), callback='parse')]
    ...
    def parse(self, response, **kwargs):
        ...
        item['email'] = response.xpath('//a[@class="details--table-cell__email icon__email"]/@href').get().replace('mailto:', '')
