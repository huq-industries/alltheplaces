...
class OliveGardenSpider(SitemapSpider):
    ...
    def parse_store(self, response, store_id, website):
        ...
        oh = OpeningHours()
        for day in days:
            oh.add_range(day=DAYS[day.get('dayOfWeek') - 1], open_time=day.get('startTime'), close_time=day.get('endTime'), time_format='%I:%M%p')
