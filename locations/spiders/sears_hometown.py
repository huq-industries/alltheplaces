...
class SearsHometownSpider(scrapy.Spider):
    name = "sears_hometown"
    item_attributes = {"brand": "Sears Hometown", "brand_wikidata": "Q69926963"}
    allowed_domains = ["api.searshometownstores.com"]
    start_urls = ["https://api.searshometownstores.com/lps-mygofer/api/v1/mygofer/store/getStateDetails"]
